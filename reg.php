...
//判断post和session是否相同，判断文本是否为空；
	if($_POST['mobile']!=$_SESSION['mobile'] or $_POST['mobile_code']!=$_SESSION['mobile_code'] or empty($_POST['mobile']) or empty($_POST['mobile_code'])){
		...
		$regdate = date("Ymd");
        $email=$_POST['mobile']."@139.com";
$sql = "INSERT INTO user(username,password,regdate,email,tel)VALUES('m_$username','$password','$regdate','$email','$username')";
...
<form action="reg.php" method="post" name="formUser">
	<table width="100%"  border="0" align="left" cellpadding="5" cellspacing="3">
        ...
        <tr>
          ...
          <td><input type="text" size="8" name="password" class="inputBg" /></td>
        </tr>
        <tr>
